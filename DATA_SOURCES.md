...
- **Classification target is compound identity (14-way), not mechanism-of-action.** `JUMP-Target-1_compound_metadata.tsv` has no MoA field for this compound set. See `docs/build-log.md` and `modules/1_cellpainting/README.md`'s Research question section.
